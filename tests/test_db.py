...
def test_jsonable_handles_sets_and_numpy():
    cfg = {
        "active_filters": {"min_price", "max_rsi"},
        "top_n": np.int64(25),
        "min_gain_7d": np.float64(8.0),
        ...
        [
            {
                ...
                "change_5d": 4.0,
                "change_7d": 11.0,
                "avg_vol_20d": np.int64(2_000_000),
                "dollar_vol_20d": np.int64(25_000_000),
                "rsi_14": 61.0,
                "composite_score": 88.0,
                "best_strategy": "momentum",
                "top_reasons": "strong volume",
                "flags": "",
                "score_momentum": 90.0,
                "tier_momentum": "strong",
            },
            {
                "ticker": "BBB",
                "price": 30.0,
                "change_5d": np.float64(np.nan),
                "change_7d": 9.0,
                "avg_vol_20d": np.int64(800_000),
                "dollar_vol_20d": np.int64(24_000_000),
                "rsi_14": 55.0,
